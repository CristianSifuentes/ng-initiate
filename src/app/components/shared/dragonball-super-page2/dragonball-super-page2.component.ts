...
@Component({
  ...
  templateUrl: './dragonball-super-page2.component.html',
  styleUrl: './dragonball-super-page2.component.css'
})
export class DragonballSuperPage2Component {
  ...
  addCharacter(character: Character) {
    if (!character.name || character.power <= 0) {
      return;
    }
